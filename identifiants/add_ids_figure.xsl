...
<!--   Template spécifique pour les figure TEI   -->
<xsl:template match="tei:figure">
<xsl:variable name="parent-id" select="(ancestor::tei:div1 | ancestor::tei:div2 | ancestor::tei:div3 | ancestor::tei:div4 | ancestor::tei:div5)[last()]/@xml:id"/>
<xsl:variable name="position" select="count(preceding-sibling::tei:figure) + 1"/>
